...
var query_search_courses_by_institute = fs.readFileSync(__dirname + dir_2 + 'search_by_institute.sql', 'utf8').toString();
var query_search_courses = fs.readFileSync(__dirname + dir_2 + 'search.sql', 'utf8').toString();
                            ...
                            client.query(query_get_member, [
                                ...
                                if (err) {
                                    ...
                                    if (result.rows.length === 0) {
                                        ...
                                        callback(null, client, done, result.rows[0], query_search_courses_by_institute);
                                    }
                                }
                            });
                        } else {
                            callback(null, client, done, undefined, query_search_courses);
                        }
                    }
                });
            } else {
