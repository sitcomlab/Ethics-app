...
var query_search_members_by_university = fs.readFileSync(__dirname + dir_2 + 'search_by_university.sql', 'utf8').toString();
...
exports.request = function(req, res) {
    ...
    async.waterfall([
        ...
        function(client, done, params, callback) {
            // Database query
            client.query(query_search_members_by_university, params, function(err, result) {
                done();
                if (err) {
                    callback(err, 500);
                } else {
