...
var query_list_members_by_university_of_member = fs.readFileSync(__dirname + dir_2 + 'list_by_university.sql', 'utf8').toString();
                            ...
                            client.query(query_get_member, [
                                ...
                                if (err) {
                                    ...
                                    if (result.rows.length === 0) {
                                        ...
                                        callback(null, client, done, result.rows[0], undefined, query_list_members_by_university_of_member);
                                    }
                                }
                            });
