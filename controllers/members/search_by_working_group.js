...
var query_search_members_by_working_group = fs.readFileSync(__dirname + dir_2 + 'search_by_working_group.sql', 'utf8').toString();


// SEARCH BY WORKING GROUP
exports.request = function(req, res) {
    ...
    async.waterfall([
        ...
        function(client, done, params, callback) {
            // Database query
            client.query(query_search_members_by_working_group, params, function(err, result) {
                done();
                if (err) {
                    callback(err, 500);
                } else {
