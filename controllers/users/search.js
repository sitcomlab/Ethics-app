...
var query_search_users_by_institute = fs.readFileSync(__dirname + dir_2 + 'search_by_institute.sql', 'utf8').toString();
...
exports.request = function(req, res) {
    ...
    async.waterfall([
        ...
        function(client, done, params, callback) {
            // Database query
            client.query(query_search_users_by_institute, params, function(err, result) {
                done();
                if (err) {
                    callback(err, 500);
                } else {
