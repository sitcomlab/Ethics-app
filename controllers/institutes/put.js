...
var query_get_institutes = fs.readFileSync(__dirname + dir + 'get.sql', 'utf8').toString();
var query_edit_institutes = fs.readFileSync(__dirname + dir + 'edit.sql', 'utf8').toString();
