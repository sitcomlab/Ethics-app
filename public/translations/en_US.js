...
app.constant("en_US", {
    ...
    DESCRIPTION_4: 'Purpose (description for the participant)',
    DESCRIPTION_5: 'Procedure (description for the participant)',
    ...
    DESCRIPTION_9: 'Describe your experiment to the Ethics Board (this box will not be shown to the participant)',
    ...
    DESCRIPTION_4_INFO: 'Describe the purpose of your study to the participant. This information will be visible to the participant, so do not disclose information that might bias the behaviour and responses of your participant in the study.',
    DESCRIPTION_5_INFO: 'Describe the procedure of your study to the participant. This information will be visible to the participant, so do not disclose information that might bias the behaviour and responses of your participant in the study.',
    ...
    DESCRIPTION_9_INFO: 'Please describe the purpose and procedure of your study to the Ethics Board. This information will not be visible to the participants of your study. Make sure to describe all conditions that your experiment will contain and aspects of the experimental design that will not be obvious to the participants.',
    ...
    CONCERN_14: 'Do you use any additional forms/documents in your study? If yes, upload them here.',
    ...
    CONCERN_15_1_INFO: 'While preparing your data for publication we recommend that you follow the AGILE Reproducible Paper Guidelines: https://osf.io/numa5/ ',
