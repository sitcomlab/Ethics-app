...
app.constant("en_US", {
    ...
    PLEASE_TYPE_IN_THE_ID_OF_THE_DOCUMENT_TO_CONFIRM: 'Please type in the document-ID to confirm',
    ...
    STATUS_INFO_0: 'A new document has been created, but the user has to fill it out.',
    STATUS_INFO_1: 'The user has started to fill out the document.',
    STATUS_INFO_2: 'The user submitted the document without ethical concerns, so it was auto-accpeted by the system. The user is now able to download the corresponding files.',
    STATUS_INFO_3: 'The user submitted the document with one or more ethical concerns. The document needs to be reviewed.',
    STATUS_INFO_4: 'A committee member has started to review the document, but has not published his/her feedback yet.',
    STATUS_INFO_4_WARNING: 'If you open the review from a document, which a different committee member has started to review you will overwrite him/her feedback! Please make sure who will be responsible for the document before you proceed!',
    STATUS_INFO_5: 'The document has been reviewed, but needs to be revised by the user based on the  feedback of the committee member published for him/her.',
    STATUS_INFO_6: 'The document has been reviewed and accepted. The user is now able to download the corresponding files.',
    STATUS_INFO_7: 'The document has been reviewed and rejected. The user can no longer access the document and corresponding files.',
    ...
    REVISING_INFORMATION_1: 'If you want to change some details of your study or fix some mistakes you can revert your document to its initial draft phase. Please note that this resets your progress as the document have to be approved by the Ethics-Committee again!',
    HERE: 'here',
    REVISING_INFORMATION_2: 'If you want to change some details of your study or fix some mistakes you can revert your document to its initial draft phase. Please ask the corresponding reviewer of the Ethics-Committee first! S/he has to review the document again! You can find your corresponding reviewer ',
    REVISING_INFORMATION_3: 'It is recommended to ask him/her directly, because s/he is already familar with your document',
    ...
    SHOW_LATEST_REVISION: 'Show latest revision',
    HIDE_LATEST_REVISION: 'Hide latest revision',
    SHOW_ENGLISH_DESCRIPTION: 'Show English description',
    HIDE_ENGLISH_DESCRIPTION: 'Hide English description',
    SHOW_GERMAN_DESCRIPTION: 'Show German description',
    HIDE_GERMAN_DESCRIPTION: 'Hide German description',
    SHOW_PORTUGUESE_DESCRIPTION: 'Show Portuguese description',
    HIDE_PORTUGUESE_DESCRIPTION: 'Hide Portuguese description',
    SHOW_CONCERNS: 'Show concerns',
    HIDE_CONCERNS: 'Hide concerns',
    ...
    GENERAL_COMMENT: 'Comment for researcher(s)',
    AUTHOR: 'Author',
    NOTES: 'Notes',
    NOTES_INFO: 'This note is only visible for committee members',
    MEMBERS: 'Members',
    MEMBER: 'Member',
    USERS: 'Users',
    USER: 'User',
    ...
    CLOSE: 'Close',
    _CLOSE: 'close',
    CLOSE_UNPUBLISHED_REVIEW: 'close unpublished review',
