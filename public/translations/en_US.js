...
app.constant("en_US", {
    ...
    ALTERNATIVE_DOCUMENT: 'If you don\'t want to delete EVERYTHING associated with this document you can also temporarily reject the document, so that the user has no longer access to it',
    ...
    ALTERNATIVE_ADMIN: 'An administrator can not be deleted, but you can revoke the admin privileges and then change the member to a former member or delete the member',
    ...
    EXPLANATION_OF_DELETING_A_INSTITUTE: 'Deleting an institute also deletes ALL ASSOCIATED working groups, committee members, users and documents. PLEASE PROCEED WITH CAUTION!',
    ...
    PLEASE_TYPE_IN_THE_WORKING_GROUP_NAME_TO_CONFIRM: 'Please type in the name of the working group to confirm',
    ...
    COURSE_DESCRIPTION_1: 'If you are creating this document for a course, please select the appropriate course from the selection below. If you cannot find it, please ask your lecturer to add it to the list (It is possible to change the course later in the document settings).',
    ...
    INTRODUCTION_TEXT_FRAGMENT_1: 'This web app will guide you in creating the necessary forms for your user study. You will be asked a series of questions, based on which the Ethics-App will auto-generate appropriate documents. If the process is unclear please refer to the Help Section.',
    ...
    INTRODUCTION_TEXT_FRAGMENT_5: 'The Statement of the researcher provides guidelines for carrying out the study itself. You need to sign the statement and store it safely together with the Informed Consent forms. This form is only for yourself and should not be handed to the participant.',
    ...
    INTRODUCTION_TEXT_FRAGMENT_12: 'The cover sheet is handed in together with the signed Consent Forms to the secretariat. It will be filled out automatically. Please note that your forms will be rejected by the secretariat if the appropriate cover sheet is not supplied.',
    ...
    STATUS_7: 'Unfortunately your document has been rejected by the Ethics-Committee. Please get in contact with the corresponding reviewer',
    ...
    STUDY_DESCRIPTION_INFO: 'This form will be used to automatically generate the informed consent form that every participant of your study will have to sign. Please fill out the English version and optionally the language-specific version appropriate for your participants. Depending on the language(s), you will receive the informed consent forms for your experiment',
    LANGUAGE_OPTIONS: 'Please select the language, in which you want to generate the informed consent forms',

    EXAMPLE: 'Example',
    DESCRIPTION_1_INFO: 'Please type in an official study title',
    DESCRIPTION_1_INFO_2: 'this title will be used in the generated PDFs. You can also use your document working if it is already an official title. Please choose a title, which is easy to understand for your participants',
    ...
    CONCERN_1_INFO: 'For instance: participants under the age of 18, participants with impairments, patients, people assisted by a caregiver, people recruited from groups associated with a specific mental or physical condition.',
    CONCERN_2_INFO: 'That is to say: Will participants be deliberately misled in such a way that they might show distress or ask to retract their data when debriefed?',
    ...
    CONCERN_6_INFO: '',
    CONCERN_7_INFO: 'For instance: attaching anything to participants\'s bodies, requiring participants to perform physically demanding gestures or poses, operating equipment.',
    CONCERN_8_INFO: '',
    ...
    AUTO_SAVING_HINT: 'You don\'t need to submit your document now! Every time you clicked on the \'Next page\' buttons in the previous pages (\'Study description\' and \'Study concerns\') all your information was automatically saved in the background. As soon as you enter this page (\'Submit\'), you can safely logout and come back later to continue your work.',
    ...
    HERE: 'here',
    REVISING_INFORMATION_2: 'If you want to change some Details of the Study or fix some mistakes in this draft of the study, you can revert your study to the initial Draft Phase again. Please speak to the corresponding reviewer from the Ethics-Committee first! They will have to review the document all over again. You can find your corresponding reviewer ',
    REVISING_INFORMATION_3: 'It is recommended that you ask them directly, because they are already familiar with your document',
    ...
    EXPLANATION_OF_THE_ADMIN_ROLE: 'If you give a member admin privileges, he/she has gets full access to all data in the database and he/she can administrate it. As an administrator you can create new universities, institutes, working groups, members and update or archive them.',
    EXPLANATION_OF_THE_FORMER_STATUS: 'This setting can only be changed by an administrator. It is used to archive your account, so that you will have no longer access to it. But all data is still be stored in the database and your account can reactivated by the administrator, in case you need access again.',
    ...
    EXPLANATION_OF_THE_FORMER_STATUS_OF_AN_INSTITUTE: 'With this setting you can archive an institute. The Institute can no longer be selected by users or members, but all associated data will still be stored in the database. This is the recommended way of removing an institute, as it retains all the associated data, while completely deleting an institute also deletes all related working groups, members, users and documents.',
    EXPLANATION_OF_THE_FORMER_STATUS_OF_A_WORKING_GROUP: 'With this setting you can archive a working group. The Working Group can no longer be selected by users or members. All data will still be stored in the database. This is the the recommended way to remove a working group, as it retains all the associated data, while  deleting a working group also, deletes all related working groups, members, users and documents.',
    ...
    LOADING_MEMBER: 'Loading committee member',
    LOADING_MEMBERS: 'Loading committee members',
    LOADING_RELATED_MEMBERS: 'Loading related committee members',
    ...
    ALERT_PASSWORD_NOT_EQUAL: 'Your passwords are not the same!',
