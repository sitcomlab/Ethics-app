...
app.controller("documentReviewController", function($scope, $rootScope, $translate, $location, config, $window, $q, $authenticationService, $documentService, $revisionService, $descriptionService, $concernService) {
