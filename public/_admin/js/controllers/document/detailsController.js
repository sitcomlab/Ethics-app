...
// Document controller
app.controller("documentDetailsController", function($scope, $rootScope, $translate, $location, config, $window, $q, $authenticationService, $documentService, $revisionService, $descriptionService, $concernService) {
