...
app.config(function ($translateProvider) {
  $translateProvider.translations('de_DE', {
    ...
    EC_1_INFO:"For instance: children and youth under 18yo, participants with impairments, patients, people assisted by a carer, people recruited from groups associated with a specific mental or physical condition.",
    ...
    EC_11_1:'11. Does the study involve audio or film recordings potentially identifying participants?',
    ...
    EC_EXPLAIN:"explain",
    EC_GENERAL_COMMENT:"Additional comment?",
