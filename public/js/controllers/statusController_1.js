...
app.controller("statusController_1", function($scope, $rootScope, $routeParams, $translate, $location, config, $window, $q, $documentService, $revisionService, $descriptionService, $concernService) {
