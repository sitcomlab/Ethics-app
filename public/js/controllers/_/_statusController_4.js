...
app.controller("statusController_4", function($scope, $rootScope, $translate, $location, config, $window, $documentService, $revisionService, $descriptionService, $concernService, $q) {
