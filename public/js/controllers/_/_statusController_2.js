...
app.controller("statusController_2", function($scope, $rootScope, $translate, $location, config, $window, $documentService, $fileService) {
...
// Document status 2 controller
app.controller("statusController_2", function($scope, $rootScope, $translate, $location, config, $window, $q, $documentService, $revisionService, $descriptionService, $concernService, $fileService) {
