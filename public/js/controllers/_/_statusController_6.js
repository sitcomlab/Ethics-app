...
app.controller("statusController_6", function($scope, $rootScope, $translate, $location, config, $window, $documentService, $revisionService, $descriptionService, $concernService, $q) {
