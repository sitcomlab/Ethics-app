...
app.controller("statusController_5", function($scope, $rootScope, $translate, $location, config, $window, $documentService, $revisionService, $descriptionService, $concernService, $q) {
