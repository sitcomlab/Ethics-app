...
app.controller("statusController_1", function($scope, $rootScope, $translate, $location, config, $window, $q, $documentService, $revisionService, $descriptionService, $concernService) {
