...
app.controller("statusController_3", function($scope, $rootScope, $translate, $location, config, $window, $documentService, $revisionService, $descriptionService, $concernService, $q) {
