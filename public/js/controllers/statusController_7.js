...
app.controller("statusController_7", function($scope, $rootScope, $routeParams, $translate, $location, config, $window, $documentService, $revisionService, $descriptionService, $concernService, $q) {
