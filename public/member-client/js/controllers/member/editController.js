...
app.controller("memberEditController", function($scope, $rootScope, $routeParams, $translate, $location, config, $window, $authenticationService, $memberService, $universityService, $instituteService, $workingGroupService) {
