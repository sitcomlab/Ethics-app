...
app.controller("memberCreateController", function($scope, $rootScope, $routeParams, $translate, $location, config, $window, $authenticationService, $instituteService, $workingGroupService, $memberService) {
