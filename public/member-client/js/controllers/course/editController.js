...
app.controller("courseEditController", function($scope, $rootScope, $routeParams, $translate, $location, config, $window, $authenticationService, $courseService, $memberService, $documentsService) {
