...
// LIST
// router.get('/revisions/:revision_id/concerns/', list.request);

// POST
// router.post('/revisions/:revision_id/concerns/', post.request);

// GET
// router.get('/revisions/:revision_id/concerns/:concern_id', get.request);

// PUT
// router.put('/revisions/:revision_id/concerns/:concern_id', put.request);

// DELETE
// router.delete('/revisions/:revision_id/concerns/:concern_id', del.request);


// LIST
// router.get('/concerns/', list.request);

// POST
// router.post('/concerns/', post.request);

// GET
// router.get('/concerns/:concern_id', get.request);

// PUT
// router.put('/concerns/:concern_id', put.request);

// DELETE
// router.delete('/concerns/:concern_id', del.request);
