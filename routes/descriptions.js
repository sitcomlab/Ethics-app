...
// POST
//router.post('/documents/:document_id/revisions/:revision_id/:language/description', post.request);
// router.post('/revisions/:revision_id/:language/description', post.request);

// GET
// router.get('/documents/:document_id/revisions/:revision_id/descriptions/:description_id', get.request);

// PUT
//router.put('/documents/:document_id/revisions/:revision_id/:language/descriptions/:description_id', put.request);
